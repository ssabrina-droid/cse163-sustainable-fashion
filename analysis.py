...
Hypothesis testing and visualizations for the Sustainable Fashion:
Eco-Friendly Trends dataset.

This module runs an independent-samples t-test to check whether
brands with eco-friendly manufacturing produce a significantly
different amount of waste than brands without it, and produces two
visualizations comparing the two groups. It relies on
data_processing.py to load and summarize the raw data.

Run this file directly to regenerate the hypothesis test result and
plots:
    python analysis.py
"""
...
def main():
    ...
    # Sanity-check the data before analyzing it.
